<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Profile.master" AutoEventWireup="true" CodeBehind="MyGiftList.aspx.cs" Inherits="Site.Areas.WeChat.Pages.MyGiftList" %>
    ...
    <style type="text/css">
        .form-style-10 {
       	...
       	<div class="table-responsive">
			<asp:GridView ID="MyGiftListView" runat="server" CssClass="table table-striped" GridLines="None" AlternatingRowStyle-CssClass="alternate-row" AllowSorting="true"
			OnSorting="AcceptedMyGiftList_Sorting" OnRowDataBound="MyGiftList_OnRowDataBound" >
				<EmptyDataTemplate>
