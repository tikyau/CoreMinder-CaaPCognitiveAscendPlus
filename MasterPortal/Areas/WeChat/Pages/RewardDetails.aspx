<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/WebForms.master" AutoEventWireup="true" CodeBehind="RewardDetails.aspx.cs" Inherits="Site.Areas.WeChat.Pages.RewardDetails" %>
...
<asp:Content ContentPlaceHolderID="EntityControls" runat="server">
    ...
    <div class="col-sm-4">
        <asp:Image ID="giftimage" CssClass="img-rounded img-responsive" runat="server" />
    </div>
    <div class="col-md-8"> 
