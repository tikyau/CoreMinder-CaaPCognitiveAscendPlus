<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Profile.master" AutoEventWireup="true" CodeBehind="MembershipList.aspx.cs" Inherits="Site.Areas.WeChat.Pages.MembershipList" %>
    ...
    <style type="text/css">
        .form-style-10 {
       	...
       	<div class="table-responsive">
			<asp:GridView ID="MembershipListView" runat="server" CssClass="table table-striped" GridLines="None" AlternatingRowStyle-CssClass="alternate-row" AllowSorting="true"
			OnSorting="AcceptedMembershipList_Sorting" OnRowDataBound="Membership_OnRowDataBound" >
				<EmptyDataTemplate>
