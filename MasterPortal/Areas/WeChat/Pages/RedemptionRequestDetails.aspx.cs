...
{
    public partial class RedemptionRequestDetails : PortalPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                XrmContext.CreateQuery("new_redemptionrequest").FirstOrDefault(c => c.GetAttributeValue<Guid>("new_redemptionrequestid") == id);
            }

            Guid redeemGuid = id;
            QueryExpression qe = new QueryExpression("new_redemptionrequest");
            ...
            if (ec.Entities.Count > 0)
            {
                ...
                string encoding = ec.Entities[0]["new_redemptionrequestid"].ToString();
                ...
                redeemQrImage.ImageUrl = "data:image/jpeg;base64," + base64String;
            }
        }
