<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/WebForms.master" AutoEventWireup="true" CodeBehind="MembershipDetails.aspx.cs" Inherits="Site.Areas.WeChat.Pages.MembershipDetails" %>
...
<asp:Content ContentPlaceHolderID="EntityControls" runat="server">
    ...
    <div class="col-sm-2">
        <asp:Image ID="membershipQrImage" CssClass="img-rounded img-responsive" runat="server" />
    </div>
    <div class="col-md-8"> 
        <adx:EntityForm ID="EntityFormControl" runat="server" FormCssClass="crmEntityFormView readonly form-style-10" PreviousButtonCssClass="btn btn-default" NextButtonCssClass="btn btn-primary" SubmitButtonCssClass="btn btn-primary" ClientIDMode="Static" LanguageCode="<%$ SiteSetting: Language Code, 0 %>" PortalName="<%$ SiteSetting: Language Code %>" />
    </div>
